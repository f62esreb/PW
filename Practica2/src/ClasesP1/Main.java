...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GestorUsuarios gestorUsuarios = new GestorUsuarios(new UserDAO());
        GestorDePistas gestorPistas = new GestorDePistas(new PistasDAO());
        GestorReservas gestorReservas = new GestorReservas(gestorUsuarios, gestorPistas,new ReservasDAO());
